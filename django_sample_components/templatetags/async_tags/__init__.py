...
from .async_dynamic_content_button import async_dynamic_content_button
...
from .async_popup_registration_form import async_popup_registration_form
...
register.simple_tag(async_dynamic_content_button, takes_context=True)
...
register.simple_tag(async_popup_registration_form, takes_context=True)
